...
function GithubIcon({ size = 28, className }: { size?: number; className?: string }) {
  return (
  ...
  return (
    <section id="contact" className="relative bg-black py-20 lg:py-32 overflow-hidden" aria-labelledby="contact-heading">
      ...
      <div className="relative max-w-[900px] mx-auto px-6 sm:px-12 text-center">
        <AnimatedSection>
          <Heading as="h2" size="hero" centered id="contact-heading">
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-[800px] mx-auto items-stretch">
          {contactLinks.map((link, index) => {
            ...
            return (
              <AnimatedItem key={link.label} delay={index * 0.1}>
                <a
                  href={link.href}
                  target="_blank"
