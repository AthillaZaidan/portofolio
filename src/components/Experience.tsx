...
export function Experience() {
  return (
    <section id="experience" className="bg-black py-20 lg:py-32" aria-labelledby="experience-heading">
      <div className="max-w-[900px] mx-auto px-6 sm:px-12">
        <AnimatedSection className="mb-12">
          <Heading as="h2" size="section" id="experience-heading">
            Where I&apos;ve shipped
          </Heading>
        ...
        <div className="relative ml-[13px]">
          ...
          <div className="space-y-12">
            {experienceEntries.map((entry, index) => (
              <AnimatedItem key={entry.company + entry.dateRange} delay={index * 0.15}>
