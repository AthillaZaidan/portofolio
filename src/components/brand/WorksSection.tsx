    ...
    <section id="works" className="bg-[#151515] px-5 py-20 text-[#f4f1ea] md:px-[2.4vw] md:py-[9vw]">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {featuredProjects.map((project, index) => (
          <BrandReveal delay={index * 0.08} key={project.id}>
            <a
              className="group block bg-[#202020] text-[#f4f1ea] transition-transform duration-500 hover:-translate-y-1 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#6d8cff]"
