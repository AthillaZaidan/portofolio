export function HeroSection() {
  return (
    <section
      id="home"
      className="relative flex min-h-screen flex-col justify-between overflow-hidden px-5 pb-6 pt-28 md:px-[2.4vw] md:pb-[2vw] md:pt-[9vw]"
    >
      <div className="grid grid-cols-12 gap-x-3 gap-y-8">
        ...
        <p className="col-span-12 max-w-[34rem] animate-[rise_.9s_cubic-bezier(.16,1,.3,1)_.12s_both] text-lg leading-[1.7] tracking-[-0.03em] text-[#3f3d38] md:col-span-5 md:col-start-6 md:text-[1.35vw]">
